...
var baseGetTag = __webpack_require__(/*! ./_baseGetTag */ 84),
...
var baseRest = __webpack_require__(/*! ./_baseRest */ 44),
    eq = __webpack_require__(/*! ./eq */ 29),
    isIterateeCall = __webpack_require__(/*! ./_isIterateeCall */ 45),
    keysIn = __webpack_require__(/*! ./keysIn */ 154);
...
var baseKeys = __webpack_require__(/*! ./_baseKeys */ 240),
...
var baseUniq = __webpack_require__(/*! ./_baseUniq */ 257);
...
var identity = __webpack_require__(/*! ./identity */ 15),
    overRest = __webpack_require__(/*! ./_overRest */ 85),
    setToString = __webpack_require__(/*! ./_setToString */ 86);
...
var basePick = __webpack_require__(/*! ./_basePick */ 233),
    flatRest = __webpack_require__(/*! ./_flatRest */ 235);
...
var baseFlatten = __webpack_require__(/*! ./_baseFlatten */ 236);
...
var createRange = __webpack_require__(/*! ./_createRange */ 250);
...
var baseDifference = __webpack_require__(/*! ./_baseDifference */ 255),
    baseRest = __webpack_require__(/*! ./_baseRest */ 44),
    isArrayLikeObject = __webpack_require__(/*! ./isArrayLikeObject */ 256);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_d3_scale__ = __webpack_require__(/*! d3-scale */ 264);
...
var apply = __webpack_require__(/*! ./_apply */ 153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_isFunction__ = __webpack_require__(/*! lodash/isFunction */ 5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_isFunction___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_lodash_isFunction__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_throttle__ = __webpack_require__(/*! lodash/throttle */ 159);
...
var RawZoomHelpers = {
  ...
  scale: function (currentDomain, evt, props, axis) {
    ...
    return __WEBPACK_IMPORTED_MODULE_4_victory_core__["a" /* Collection */].containsDates([fromBound, toBound]) ? [new Date(domain[0]), new Date(domain[1])] : domain;
  },
  ...
  getPosition: function (evt, props, originalDomain) {
    var _Selection$getSVGEven = __WEBPACK_IMPORTED_MODULE_4_victory_core__["d" /* Selection */].getSVGEventCoordinates(evt),
    ...
    return __WEBPACK_IMPORTED_MODULE_4_victory_core__["d" /* Selection */].getDataCoordinates(props, originalScale, x, y);
  },
  ...
  pan: function (currentDomain, originalDomain, delta) {
    ...
    return __WEBPACK_IMPORTED_MODULE_4_victory_core__["a" /* Collection */].containsDates(currentDomain) || __WEBPACK_IMPORTED_MODULE_4_victory_core__["a" /* Collection */].containsDates(originalDomain) ? newDomain.map(function (val) {
      return new Date(val);
    }) : newDomain;
  },
  ...
  handleAnimation: function (ctx) {
    var getTimer = __WEBPACK_IMPORTED_MODULE_1_lodash_isFunction___default()(ctx.getTimer) && ctx.getTimer.bind(ctx);

    if (getTimer && __WEBPACK_IMPORTED_MODULE_1_lodash_isFunction___default()(getTimer().bypassAnimation)) {
      getTimer().bypassAnimation();
      return __WEBPACK_IMPORTED_MODULE_1_lodash_isFunction___default()(getTimer().resumeAnimation) ? function () {
  ...
  getLastDomain: function (targetProps, originalDomain) {
    ...
    if (zoomDomain && !this.checkDomainEquality(zoomDomain, cachedZoomDomain)) {
      return __WEBPACK_IMPORTED_MODULE_0_lodash_defaults___default()({}, zoomDomain, domain);
    }

    return __WEBPACK_IMPORTED_MODULE_0_lodash_defaults___default()({}, currentDomain || zoomDomain || originalDomain, domain);
  },
  getDomain: function (props) {
    ...
    var childComponents = __WEBPACK_IMPORTED_MODULE_3_react__["Children"].toArray(children);
    var childrenDomain = {};

    if (childComponents.length) {
      childrenDomain = zoomDimension ? _defineProperty({}, zoomDimension, __WEBPACK_IMPORTED_MODULE_4_victory_core__["g" /* Wrapper */].getDomainFromChildren(props, zoomAxis, childComponents)) : {
        x: __WEBPACK_IMPORTED_MODULE_4_victory_core__["g" /* Wrapper */].getDomainFromChildren(props, xAxis, childComponents),
        y: __WEBPACK_IMPORTED_MODULE_4_victory_core__["g" /* Wrapper */].getDomainFromChildren(props, yAxis, childComponents)
      };
    }

    return __WEBPACK_IMPORTED_MODULE_0_lodash_defaults___default()({}, childrenDomain, originalDomain, domain);
  },
  onMouseDown: function (evt, targetProps) {
    ...
    var parentSVG = targetProps.parentSVG || __WEBPACK_IMPORTED_MODULE_4_victory_core__["d" /* Selection */].getParentSVG(evt);

    var _Selection$getSVGEven2 = __WEBPACK_IMPORTED_MODULE_4_victory_core__["d" /* Selection */].getSVGEventCoordinates(evt, parentSVG),
  ...
  onMouseMove: function (evt, targetProps, eventKey, ctx) {
    if (targetProps.panning && targetProps.allowPan) {
      ...
      var _Selection$getSVGEven3 = __WEBPACK_IMPORTED_MODULE_4_victory_core__["d" /* Selection */].getSVGEventCoordinates(evt, parentSVG),
      ...
      if (__WEBPACK_IMPORTED_MODULE_1_lodash_isFunction___default()(onZoomDomainChange)) {
        onZoomDomainChange(currentDomain, __WEBPACK_IMPORTED_MODULE_0_lodash_defaults___default()({}, mutatedProps, targetProps));
      }
...
/* harmony default export */ __webpack_exports__["b"] = ({
  ...
  onMouseMove: __WEBPACK_IMPORTED_MODULE_2_lodash_throttle___default()(RawZoomHelpers.onMouseMove.bind(RawZoomHelpers), 16, // eslint-disable-line no-magic-numbers
  {
    leading: true,
    trailing: false
  }),
  onWheel: __WEBPACK_IMPORTED_MODULE_2_lodash_throttle___default()(RawZoomHelpers.onWheel.bind(RawZoomHelpers), 16, // eslint-disable-line no-magic-numbers
  {
    leading: true,
    trailing: false
  })
...
var freeGlobal = __webpack_require__(/*! ./_freeGlobal */ 162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__victory_label_victory_label__ = __webpack_require__(/*! ./victory-label/victory-label */ 239);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__victory_clip_container_victory_clip_container__ = __webpack_require__(/*! ./victory-clip-container/victory-clip-container */ 241);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__victory_theme_victory_theme__ = __webpack_require__(/*! ./victory-theme/victory-theme */ 242);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__victory_primitives_arc__ = __webpack_require__(/*! ./victory-primitives/arc */ 245);
/* unused harmony reexport Arc */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__victory_primitives_border__ = __webpack_require__(/*! ./victory-primitives/border */ 246);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__victory_primitives_line_segment__ = __webpack_require__(/*! ./victory-primitives/line-segment */ 247);
/* unused harmony reexport LineSegment */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__victory_primitives_point__ = __webpack_require__(/*! ./victory-primitives/point */ 248);
/* unused harmony reexport Point */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__victory_primitives_whisker__ = __webpack_require__(/*! ./victory-primitives/whisker */ 252);
/* unused harmony reexport Whisker */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__victory_util_add_events__ = __webpack_require__(/*! ./victory-util/add-events */ 253);
...
var root = __webpack_require__(/*! ./_root */ 88);
...
var toNumber = __webpack_require__(/*! ./toNumber */ 89);
...
var baseGet = __webpack_require__(/*! ./_baseGet */ 53),
    baseSet = __webpack_require__(/*! ./_baseSet */ 234),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_lodash_invert__ = __webpack_require__(/*! lodash/invert */ 341);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__victory_zoom_container__ = __webpack_require__(/*! ./victory-zoom-container */ 152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__zoom_helpers__ = __webpack_require__(/*! ./zoom-helpers */ 87);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react__ = __webpack_require__(/*! react */ 0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__zoom_helpers__ = __webpack_require__(/*! ./zoom-helpers */ 87);
      ...
      return [{
        ...
        eventHandlers: {
          ...
          onWheel: function (evt, targetProps, eventKey, ctx) {
            ...
            return props.disable ? {} : __WEBPACK_IMPORTED_MODULE_4__zoom_helpers__["b" /* default */].onWheel(evt, targetProps, eventKey, ctx);
          }
        }
      }];
    }
...
var debounce = __webpack_require__(/*! ./debounce */ 160),
    isObject = __webpack_require__(/*! ./isObject */ 8);
...
var isObject = __webpack_require__(/*! ./isObject */ 8),
    now = __webpack_require__(/*! ./now */ 161),
    toNumber = __webpack_require__(/*! ./toNumber */ 89);
...
var arrayMap = __webpack_require__(/*! ./_arrayMap */ 22),
    ...
    baseUnary = __webpack_require__(/*! ./_baseUnary */ 103),
...
var arrayPush = __webpack_require__(/*! ./_arrayPush */ 237),
    isFlattenable = __webpack_require__(/*! ./_isFlattenable */ 238);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__victory_util_helpers__ = __webpack_require__(/*! ../victory-util/helpers */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__victory_util_label_helpers__ = __webpack_require__(/*! ../victory-util/label-helpers */ 117);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__victory_primitives_tspan__ = __webpack_require__(/*! ../victory-primitives/tspan */ 118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__victory_primitives_text__ = __webpack_require__(/*! ../victory-primitives/text */ 119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__victory_util_prop_types__ = __webpack_require__(/*! ../victory-util/prop-types */ 19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__victory_util_helpers__ = __webpack_require__(/*! ../victory-util/helpers */ 3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__victory_primitives_clip_path__ = __webpack_require__(/*! ../victory-primitives/clip-path */ 121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__victory_primitives_circle__ = __webpack_require__(/*! ../victory-primitives/circle */ 122);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__material__ = __webpack_require__(/*! ./material */ 243);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__grayscale__ = __webpack_require__(/*! ./grayscale */ 244);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__path_helpers__ = __webpack_require__(/*! ./path-helpers */ 249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__victory_util_common_props__ = __webpack_require__(/*! ../victory-util/common-props */ 20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__path__ = __webpack_require__(/*! ./path */ 70);
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }
...
var baseRange = __webpack_require__(/*! ./_baseRange */ 251),
    isIterateeCall = __webpack_require__(/*! ./_isIterateeCall */ 45),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_isNil__ = __webpack_require__(/*! lodash/isNil */ 254);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_groupBy__ = __webpack_require__(/*! lodash/groupBy */ 336);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_some__ = __webpack_require__(/*! lodash/some */ 340);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__axis__ = __webpack_require__(/*! ./axis */ 150);
...
var baseAssignValue = __webpack_require__(/*! ./_baseAssignValue */ 64),
    createAggregator = __webpack_require__(/*! ./_createAggregator */ 337);
...
var arrayAggregator = __webpack_require__(/*! ./_arrayAggregator */ 338),
    baseAggregator = __webpack_require__(/*! ./_baseAggregator */ 339),
    baseIteratee = __webpack_require__(/*! ./_baseIteratee */ 23),
    isArray = __webpack_require__(/*! ./isArray */ 7);
...
var constant = __webpack_require__(/*! ./constant */ 342),
    createInverter = __webpack_require__(/*! ./_createInverter */ 343),
    identity = __webpack_require__(/*! ./identity */ 15);
...
var baseInverter = __webpack_require__(/*! ./_baseInverter */ 344);
...
var baseForOwn = __webpack_require__(/*! ./_baseForOwn */ 345);
...
var baseFor = __webpack_require__(/*! ./_baseFor */ 346),
    keys = __webpack_require__(/*! ./keys */ 16);
...
var createBaseFor = __webpack_require__(/*! ./_createBaseFor */ 347);
