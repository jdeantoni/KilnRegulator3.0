...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('currentSegment')) {
        obj['currentSegment'] = ApiClient.convertToType(data['currentSegment'], 'String');
      }
   ...
   * @member {String} currentSegment
   */
  exports.prototype['currentSegment'] = undefined;
  /**
